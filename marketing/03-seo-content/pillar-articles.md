...
|---|---|---|---|---|---|
| 1 | How to sell your flowers locally without building a website | how to sell flowers locally | Grower | **published** | `content/blog/how-to-sell-flowers-locally-without-a-website.md`. The flagship. Doubles as a manifesto. Has FAQ schema. |
| 2 | How to price cut flowers for florists (a grower's guide) | how to price cut flowers | Grower | **published** | `content/blog/how-to-price-cut-flowers-for-florists.md`. [PR #3](https://github.com/JamieCurnow/stems/pull/3) merged. Fact-checked (Hampshire Seed Co cost example, ~85-90% import stat); per-stem figures intentionally left as method guidance, no hard numbers. Has FAQ schema. |

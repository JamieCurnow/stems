    ...
    <template #body>
      <div class="space-y-4">
        <p class="text-sm text-neutral-600 dark:text-neutral-400">
          Choose which categories of cookies you're happy with. Strictly functional cookies are always on — without them sign-in and billing wouldn't work.
        </p>

        <div class="flex items-start justify-between gap-4 rounded-lg border border-neutral-200 p-3 dark:border-neutral-800">
          <div>
        ...
        <div class="flex items-start justify-between gap-4 rounded-lg border border-neutral-200 p-3 dark:border-neutral-800">
          <div>
            ...
            <p class="mt-0.5 text-xs text-neutral-500">Anonymised usage metrics so we can improve the product.</p>
          </div>

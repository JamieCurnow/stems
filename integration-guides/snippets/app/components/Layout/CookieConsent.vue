...
<template>
  ...
  >
    <p class="text-sm text-neutral-700 dark:text-neutral-300">
      We use cookies to make the app work, measure usage, and (with your permission) personalise marketing. You can change your choice any time from the cookies page.
    </p>
    <div class="mt-4 flex flex-wrap items-center gap-2">
      <UButton size="sm" color="neutral" variant="solid" @click="consent.acceptAll()">
        Accept all
      </UButton>
      <UButton size="sm" color="neutral" variant="soft" @click="consent.rejectAll()">
        Reject non-essential
      </UButton>
      <UButton size="sm" color="neutral" variant="ghost" @click="openManage">
        Manage
      </UButton>
    </div>
